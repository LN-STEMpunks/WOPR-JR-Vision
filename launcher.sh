...
# Camera 0, and 1
/usr/bin/env python ${VISIONREPO}/src/grip.py -mjpg 5802 -f ${VISIONREPO}/lab.conf --publish -c 0 &
/usr/bin/env python ${VISIONREPO}/src/grip.py -mjpg 5803 -f ${VISIONREPO}/lab.conf --publish -c 1 &
